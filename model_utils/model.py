...
class FullyCNNSEModel(object):
    ...
    def decode(self, x):
        ...
        x = conv_bn_relu(x, 12, kernel_size=(8, 13), stride=(1, 1), is_training=self.is_training, scope="decode_4", skip_input=self.encode_1)
...
class FullyCNNSEModelV3(object):
    ...
    def encode(self, x):
        self.encode_1 = conv_bn_relu(x, 18, kernel_size=(8, 9), stride=(1, 1), is_training=self.is_training, scope="encode_1")
        self.encode_2 = conv_bn_relu(self.encode_1, 30, kernel_size=(1, 5), stride=(1, 1), is_training=self.is_training, scope="encode_2")
        self.encode_3 = conv_bn_relu(self.encode_2, 8, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="encode_3")
        self.encode_4 = conv_bn_relu(self.encode_3, 18, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="encode_4")
        self.encode_5 = conv_bn_relu(self.encode_4, 30, kernel_size=(1, 5), stride=(1, 1), is_training=self.is_training, scope="encode_5")
        self.encode_6 = conv_bn_relu(self.encode_5, 8, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="encode_6")
        self.encode_7 = conv_bn_relu(self.encode_6, 18, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="encode_7")
        encode_8 = conv_bn_relu(self.encode_7, 30, kernel_size=(1, 5), stride=(1, 1), is_training=self.is_training, scope="encode_8")
        return encode_8

    def decode(self, x):
        x = conv_bn_relu(x, 8, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="decode_1", skip_input=self.encode_6)
        x = conv_bn_relu(x, 18, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="decode_2", skip_input=self.encode_7)
        x = conv_bn_relu(x, 30, kernel_size=(1, 5), stride=(1, 1), is_training=self.is_training, scope="decode_3", skip_input=self.encode_5)
        x = conv_bn_relu(x, 8, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="decode_4", skip_input=self.encode_3)
        x = conv_bn_relu(x, 18, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="decode_5", skip_input=self.encode_4)
        x = conv_bn_relu(x, 30, kernel_size=(8, 5), stride=(1, 1), is_training=self.is_training, scope="decode_6", skip_input=self.encode_2)
        x = conv_bn_relu(x, 8, kernel_size=(1, 9), stride=(1, 1), is_training=self.is_training, scope="decode_7")
        x = conv_bn_relu(x, 1, kernel_size=(1, 129), stride=(1, 1), is_training=self.is_training, scope="decode_8", use_norm=False, use_act=False)
        return x
